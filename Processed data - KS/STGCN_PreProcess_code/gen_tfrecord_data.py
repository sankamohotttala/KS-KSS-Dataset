...
if __name__ == '__main__':
    ...
    # output_folder=r'F:\Codes\joint attention\2022 - comparison paper\kineticsSTGCN_code\data\st-gcn-processed-data\data\Kinetics\kinetics-skeleton\AllAdultData_3ClassNewAttempt'

    output_folder=r'F:\Codes\joint attention\2022 - comparison paper\kineticsSTGCN_code\data\st-gcn-processed-data\data\Kinetics\kinetics-skeleton\fourClassesTest\adult'
    ...
    if trainOrVal=='train': 
        ...
        data_path=output_folder+'/train_data.npy'
        dest_path= output_folder+'/train_data/' 
    else:
        lable_path=output_folder+'/val_label.pkl'
        data_path=output_folder+'/val_data.npy'
        dest_path= output_folder+'/val_data/' 

    parser = argparse.ArgumentParser(description='Kinetics Data TFRecord Converter')
